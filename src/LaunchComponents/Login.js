                ...
                .then((responseJson) => {
                    if (responseJson.status === 'TRUE') {
                        if (responseJson.role === "admin") {
                            ...
                            this.props.getRequestedIdeas(responseJson.role,responseJson.empId,cropcode);
                            this.setState({ role: responseJson.role});
                            this.setState({ userToken: responseJson.empId });
                            this.setState({ cropcode: cropcode });
                            this.props.navigation.navigate("AdminDrawer");
                        }
                        else {
                            AsyncStorage.setItem('userToken', responseJson.empId);
                            AsyncStorage.setItem('userName', responseJson.userName);
